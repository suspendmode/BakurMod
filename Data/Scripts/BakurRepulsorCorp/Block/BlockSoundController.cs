...
namespace BakurRepulsorCorp {
    ...
    public class BlockSoundController : EquipmentBase {
        ...
        public BlockSoundController(BakurBlock component, string startSoundId, string loopSoundId, string endSoundId) : base(component) {
