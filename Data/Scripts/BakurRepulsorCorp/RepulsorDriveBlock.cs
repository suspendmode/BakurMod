...
namespace BakurRepulsorCorp
{
    ...
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_TerminalBlock), true, new string[] { "SmallBlockRepulsorDrive", "LargeBlockRepulsorDrive" })]
    public class RepulsorDriveBlock : BakurBlock
    {
