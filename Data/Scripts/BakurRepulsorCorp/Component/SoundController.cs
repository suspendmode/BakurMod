...
namespace BakurRepulsorCorp
{
    ...
    public class SoundController : LogicElement
    {
        ...
        public SoundController(LogicComponent component, string startSoundId, string loopSoundId, string endSoundId) : base(component)
        {
        ...
        {
            if (block.IsWorking && logicComponent.enabled)
            {
                StartSound();
            }
            else
