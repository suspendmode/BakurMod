...
namespace BakurRepulsorCorp
{
    ...
    public class Generator_DecrasePowerAction : UIControlAction<AntiGravityGenerator>
    {

        public Generator_DecrasePowerAction() : base("Generator_DecrasePowerAction", "Decrase Power")
        {
        }
