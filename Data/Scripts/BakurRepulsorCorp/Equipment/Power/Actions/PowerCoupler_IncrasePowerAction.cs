...
namespace BakurRepulsorCorp {
    ...
    public class PowerCoupler_IncrasePowerAction : BaseControlAction<PowerCoupling> {

        public PowerCoupler_IncrasePowerAction() : base("PowerCoupler_IncrasePowerAction", "Incrase Power") {
        }
