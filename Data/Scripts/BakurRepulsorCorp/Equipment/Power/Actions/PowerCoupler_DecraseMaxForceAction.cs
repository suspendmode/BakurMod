...
namespace BakurRepulsorCorp {
    ...
    public class PowerCoupler_DecraseMaxForceAction : BaseControlAction<PowerCoupling> {

        public PowerCoupler_DecraseMaxForceAction() : base("PowerCoupler_DecraseMaxForceAction", "Decrase Max Force") {
        }
