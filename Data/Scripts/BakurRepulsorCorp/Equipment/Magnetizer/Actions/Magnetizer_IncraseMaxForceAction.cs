...
namespace BakurRepulsorCorp {
    ...
    public class Magnetizer_IncraseMaxForceAction : BaseControlAction<Magnetizer> {

        public Magnetizer_IncraseMaxForceAction() : base("Magnetizer_IncraseMaxForceAction", "Incrase Max Force") {
        }
