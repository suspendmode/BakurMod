...
namespace BakurRepulsorCorp {
    ...
    public class Magnetizer : EquipmentBase {

        public Magnetizer(BakurBlock component) : base(component) {
        }
        ...
        public void UpdateMagnetizer(double physicsDeltaTime) {
            ...
            foreach (IMyEntity entity in entitiesInRange) {
                ...
                if (physics == null || physics.IsStatic || physics.IsKinematic || physics.Enabled == false || physics == component.block.Physics || physics == component.block.CubeGrid.Physics) {
                    continue;
                }

                //MyAPIGateway.Utilities.ShowMessage("Magnetizer", "Entity: " + grid.Name);
                //int layer = entity.Physics.RigidBody.Layer;
                Vector3D direction = entity.WorldMatrix.Translation - component.block.CubeGrid.WorldMatrix.Translation;
        ...
        public override void Debug() {
            ...
            foreach (IMyEntity entity in entitiesInRange) {
                ...
                if (physics == null || physics == component.block.Physics || physics == component.block.CubeGrid.Physics) {
                    continue;
                }

                Vector3 from = component.block.WorldMatrix.Translation;
