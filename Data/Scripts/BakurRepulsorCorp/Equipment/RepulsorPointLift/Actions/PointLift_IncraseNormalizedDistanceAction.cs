...
namespace BakurRepulsorCorp {
    ...
    public class PointLift_IncraseNormalizedDistanceAction : BaseControlAction<RepulsorPointLift> {

        public PointLift_IncraseNormalizedDistanceAction() : base("PointLift_IncraseNormalizedDistanceAction", "Incrase Normalized Distance") {
        }
