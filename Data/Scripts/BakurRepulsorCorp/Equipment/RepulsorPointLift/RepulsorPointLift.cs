...
namespace BakurRepulsorCorp {
    ...
    public class RepulsorPointLift : BakurBlockEquipment {
        ...
        public double defaultProportionalCoefficient = 0.1;
        ...
        public double defaultDerivativeCoefficient = 0.003;
        ...
        void UpdateNormalizedAltitudeFromInput(double physicsDeltaTime) {
            ...
            if (shipController != null) {
                normalizedDistance += GetShipControllerLinearInput(physicsDeltaTime, shipController) * (physicsDeltaTime * 0.3f);
            }
        ...
        public Vector3D GetForce(double physicsDeltaTime, Vector3D desiredUp, double distance, float maxAltitude) {
            ...
            desiredForce = desiredUp * pid / physicsDeltaTime * component.gridMass;
