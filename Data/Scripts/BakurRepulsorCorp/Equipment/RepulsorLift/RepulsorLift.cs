...
namespace BakurRepulsorCorp {
    ...
    public class RepulsorLift : BakurBlockEquipment {
        ...
        public double defaultProportionalCoefficient = 0.01;
        ...
        */
        ...
        void UpdateNormalizedDistanceFromInput(double physicsDeltaTime) {
            ...
            if (shipController != null) {
                normalizedDistance += GetShipControllerLinearInput(physicsDeltaTime, shipController) * (physicsDeltaTime * 0.2f);
            }
