...
namespace BakurRepulsorCorp {
    ...
    public class Suspension_DecraseRestLengthAction : BaseControlAction<RepulsorSuspension> {

        public Suspension_DecraseRestLengthAction() : base("RepulsorSuspension_DecraseRestLengthAction", "Decrase Rest Length") {
        }
