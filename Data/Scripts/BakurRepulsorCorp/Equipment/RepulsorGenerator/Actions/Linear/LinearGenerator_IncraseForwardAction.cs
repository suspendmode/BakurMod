...
namespace BakurRepulsorCorp {
    ...
    public class LinearGenerator_IncraseForwardAction : BaseControlAction<RepulsorLinearGenerator> {

        public LinearGenerator_IncraseForwardAction() : base("LinearGenerator_IncraseForwardAction", "Incrase Forward Speed") {
        }
