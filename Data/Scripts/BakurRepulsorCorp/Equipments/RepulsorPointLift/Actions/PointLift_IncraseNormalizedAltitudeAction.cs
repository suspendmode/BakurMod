...
namespace BakurRepulsorCorp {
    ...
    public class PointLift_IncraseNormalizedAltitudeAction : BaseControlAction<RepulsorPointLift> {

        public PointLift_IncraseNormalizedAltitudeAction() : base("PointLift_IncraseNormalizedAltitudeAction", "Incrase Normalized Altitude") {
        }
