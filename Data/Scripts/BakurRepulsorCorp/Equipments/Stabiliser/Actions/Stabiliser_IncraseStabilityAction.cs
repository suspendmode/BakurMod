...
namespace BakurRepulsorCorp {
    ...
    public class Stabiliser_IncraseStabilityAction : BaseControlAction<AttitudeStabiliser> {

        public Stabiliser_IncraseStabilityAction() : base("TorqueStabiliser_IncraseStabilityAction", "Incrase Stability") {
        }
