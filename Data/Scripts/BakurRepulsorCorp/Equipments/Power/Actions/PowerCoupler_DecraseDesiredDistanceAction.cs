...
namespace BakurRepulsorCorp {
    ...
    public class PowerCoupler_DecraseDesiredDistanceAction : BaseControlAction<PowerCoupling> {

        public PowerCoupler_DecraseDesiredDistanceAction() : base("PowerCoupler_DecraseDesiredDistanceAction", "Decrase Desired Distance") {
        }
