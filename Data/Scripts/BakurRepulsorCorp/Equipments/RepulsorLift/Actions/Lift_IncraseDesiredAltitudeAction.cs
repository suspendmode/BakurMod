...
namespace BakurRepulsorCorp {
    ...
    public class Lift_IncraseDesiredAltitudeAction : BaseControlAction<RepulsorLift> {

        public Lift_IncraseDesiredAltitudeAction() : base("Lift_IncraseDesiredAltitudeAction", "Incrase Altitude") {
        }
